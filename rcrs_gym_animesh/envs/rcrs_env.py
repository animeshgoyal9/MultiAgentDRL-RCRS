...
class RCRSenv(gym.Env):
	...
	def __init__(self):
         ...
         self._action_set = [255, 960, 905, 934, 935, 936, 937, 298, 938, 939, 940, 941, 942, 943, 944, 945, 946, 947, 948, 949, 950, 951, 247, 952, 248, 
                            953, 249, 954, 250, 955, 251, 956, 957, 253, 958, 254, 959] 
        # General variables
    ...
    def _take_action(self, a):
        ...
        action = self._action_set[a] # This is from the rcrs simulator
